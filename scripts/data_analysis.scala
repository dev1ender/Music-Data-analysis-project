...
val MDSchemaString = "user_id:string,song_id:string,artist_id:string,timestamp:string,start_ts:string,end_ts:string,geo_cd:string,station_id:string,song_end_type:string,like:Int,dislike:Int,batchid:string,status:string"
...
//Subscribed Users
val data =sc.textFile("/user/cloudera/project/exportedata/subscribedusers/000000_0")
...
connected_artists.rdd.saveAsTextFile("/home/cloudera/Assignment/musicProject/output/connected_artists")
...
top_10_royalty_songs.rdd.saveAsTextFile("/home/cloudera/Assignment/musicProject/output/top_10_royalty_songs")
...
top_10_unsubscribed_users.rdd.saveAsTextFile("/home/cloudera/Assignment/musicProject/output/top_10_unsubscribed_users")
